---
date: "`r Sys.Date()`"
author: "Cristiane Taniguti e Fernando Correr"
output:
...
O R está diponível para os sistemas operacionais Linux, Mac e Windows. Aqui descreveremos os passos necessários para instalação em cada um deles. Caso enfrente problemas em alguma das etapas, verifique também as instruções no [site do CRAN](https://cran.r-project.org/). Se mesmo assim tiver problemas, entre em contato conosco pelo e-mail cursogmp@usp.br.
