...
```{r, eval=FALSE}
dados <- read.csv(file = "~/GLOBAL/Formulário no google drive.csv", stringsAsFactors = FALSE, na.strings = "-")
head(dados)
```

```{r, echo=FALSE}
dados <- read.csv(file = "Formulário no google drive.csv", stringsAsFactors = FALSE, na.strings="-")
```
