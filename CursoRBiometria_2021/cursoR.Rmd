...
Vamos então realizar uma análise de variância a fim de verificar se há diferenças significativas entre os meses.
...
# Sometimes need to install 'sf' (install.packages("sf")
...
Este material foi produzido por alunos do programa de pós-graduação em Genética e Melhoramento de Plantas. Cristiane Taniguti, Fernando Correr, Guilherme Hokasa, Jenifer Camila Godoy e Wellingson Araújo ministraram o Treinamento.
