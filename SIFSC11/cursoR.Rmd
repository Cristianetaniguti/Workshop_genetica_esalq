...
Também podemos importar os dados diretamente do github, utilizando o pacote _readr_.

```{r, eval=FALSE}
library(readr)
dados <- read_csv("https://github.com/Cristianetaniguti/Workshop_genetica_esalq/raw/master/SIFSC11/dados_alunos2021.csv")
